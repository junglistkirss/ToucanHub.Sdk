...
{
    public static void NotAwait(this Task originalTask)
    {
        _ = originalTask.ConfigureAwait(false);
    }

    public static void NotAwait(this ValueTask originalTask)
    {
        _ = originalTask.ConfigureAwait(false);
    }

    public static void NotAwait<T>(this Task<T> originalTask)
    {
        _ = originalTask.ConfigureAwait(false);
    }

    public static void NotAwait<T>(this ValueTask<T> originalTask)
    {
        _ = originalTask.ConfigureAwait(false);
    }
