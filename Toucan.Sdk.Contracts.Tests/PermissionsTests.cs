...
public class PermissionsTests
{
    ...
    public void TestChild_Allowed()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.False(current.Allows("Test.Assert.Spec.Child.Next"));
            Assert.False(current.Allows("Test.Assert.Spec.Child.Next.Sub"));
        });
    }
    ...
    public void TestOther_NotAllowed()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.False(current.Allows("Test.Assert.Spec.Any"));
            Assert.False(current.Allows("Test.Assert.Spec.Next"));
        });
    }
    ...
    public void Test_NotAllowed()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.True(current.Allows("Test"));
            Assert.True(current.Allows("Test.Assert"));
        });
    }
