...
public sealed class PropertyAccessor
{
    ...
    private sealed class PropertyWrapper<TObject, TValue> : IPropertyAccessor
    {
        ...
        public object? Get(object source) => getMethod((TObject)source);

        public void Set(object source, object? value) => setMethod((TObject)source, (TValue)value!);
    }
    ...
    public PropertyAccessor(PropertyInfo propertyInfo)
    {
        ...
        Type? type = typeof(PropertyWrapper<,>).MakeGenericType(propertyInfo.DeclaringType!, propertyInfo.PropertyType);
